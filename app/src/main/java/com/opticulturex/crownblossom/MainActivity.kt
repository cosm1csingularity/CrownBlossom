...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (prefs.getBoolean("activity_exec", false)) {
            Intent(this, FilterClass::class.java).also { startActivity(it) }
            finish()
        } else {
            val exec = prefs.edit()
    ...
    private fun appsdk() {
        val conversionDataListener = object : AppsFlyerConversionListener {
            override fun onConversionDataSuccess(data: Map<String, Any>) {
                ...
                CBString = (data["campaign"] as String?)!!
                Log.d("NAMING", "campaign attributed: $CBString")

                val tokenizer = StringTokenizer(CBString, "_")
    ...
    fun invHander() {
        Intent(this, FilterClass::class.java)
